...
bool TGAImage::write_tga_file(
    const std::string filename, const bool vflip, const bool rle
) const {
    ...
    out.write(
        reinterpret_cast<const char *>(developer_area_ref),
    ...
    out.write(
        reinterpret_cast<const char *>(extension_area_ref),
...
bool TGAImage::unload_rle_data(std::ofstream &out) const {
    ...
    while (curpix < npixels) {
        ...
        out.write(
            reinterpret_cast<const char *>(data.data() + chunkstart),
