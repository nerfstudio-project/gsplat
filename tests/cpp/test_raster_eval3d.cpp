...
private:
    ...
    static Eval3DScene make_scene(int tile_size)
    {
        ...
        // raster batches. With the production CHUNK_BATCHES=4, that means at
        // least two chunk slots for this single tile.
        ...
        // low-level rasterizer so the test can inspect fwd_chunk_state directly.
...
INSTANTIATE_TEST_SUITE_P(
    TileSize, FwdChunkStateTest, ::testing::Values(8, 16),
