...
def evaluate_opacity_factor3D_geometric_(
    o_minus_mu: Tensor, raydir: Tensor, giscl_rot: Tensor, dl_do: Tensor
):
    gro = giscl_rot @ o_minus_mu
...
def evaluate_opacity_factor3D_geometric__(
    e: Tensor, d: Tensor, giscl_rot: Tensor, dl_do: Tensor  # o_minus_mu
):
...
o, dl_dgiscl_rot, dl_do_minus_mu = evaluate_opacity_factor3D_geometric_(
    o_minus_mu, raydir, giscl_rot, dl_do
)
...
evaluate_opacity_factor3D_geometric__(o_minus_mu, raydir, giscl_rot, dl_do)
