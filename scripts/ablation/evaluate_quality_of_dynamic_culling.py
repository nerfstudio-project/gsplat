...
python scripts/ablation/evaluate_quality_of_dynamic_culling.py --pixel-threshold 0.01   # Set base pixel threshold to 0.01, override the default value in the config file
python scripts/ablation/evaluate_quality_of_dynamic_culling.py --save-images            # Explicitly save images  
python scripts/ablation/evaluate_quality_of_dynamic_culling.py --no-save-images         # Skip saving images
python scripts/ablation/evaluate_quality_of_dynamic_culling.py --lpips                  # To measure LPIPS, you need to pass --lpips flag. This takes a lot of time.
