...
if __name__ == "__main__":
    ...
    for culling_method in culling_methods:
        ...
        generate_all_quality_vs_gaussians_plots(culling_evaluation_dir, base_save_dir, culling_method)
        
        print(f"Completed quality vs gaussians plots for {culling_method}")
