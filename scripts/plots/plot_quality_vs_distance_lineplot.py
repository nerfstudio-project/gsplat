#!/usr/bin/env python3
"""
Plot comprehensive evaluation metrics for culling methods across different pixel sizes.
...
if __name__ == "__main__":
    ...
    for culling_method in culling_methods:
        ...
        generate_all_plots_for_method(culling_evaluation_dir, base_save_dir, culling_method)
        
        print(f"Completed plots for {culling_method}")
