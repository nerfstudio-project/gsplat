...
class Config:
    ...
    save_steps: List[int] = field(default_factory=lambda: [7_011, 10_011, 15_011, 20_111, 29_996])
    ...
    def train(self):
        ...
        for step in pbar:
            ...
            if torch.isnan(loss).any():
                ...
                print("Loss is NaN! Triggering debugger...")
            ...
            # if use forward of iresnet then optimize network
            if debug_grid == None:
