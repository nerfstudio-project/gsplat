...
class Config:
    ...
    # kernel size for the low-pass filter in rasterization. 0.1 should be a better value since it better approximates a 2D box filter of single pixel size.
...
def create_splats_with_optimizers(
    ...
    params = [
        ...
        # 3D smoothing filter, setting lr to 0.0 to disable optimization
        ("filters", torch.nn.Parameter(torch.ones_like(opacities)), 0.0),
    ]
...
class Runner:
    ...
    def rasterize_splats(
        ...
        **kwargs,
        ...
        render_colors, render_alphas, info = raytracing(
            means=means,
            quats=quats,
            scales=scales,
            opacities=opacities,
