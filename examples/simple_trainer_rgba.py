...
class Runner:
    ...
    def __init__(
        ...
        self.trainset = DatasetRGBA(
            self.parser,
            split="train",
            patch_size=cfg.patch_size,
            load_depths=cfg.depth_loss,
        )
        self.valset = DatasetRGBA(self.parser, split="val")
    ...
    def train(self):
        ...
        for step in pbar:
            ...
            if cfg.random_bkgd:
                ...
                pixels = pixels + bkgd * (1.0 - pixels_alpha)
            ...
            if cfg.random_bkgd:
                ...
                l1alphaloss = (
                    F.l1_loss(alphas, pixels_alpha)
                    if pixels_alpha.sum() > 0
                    else torch.tensor(0.0, device=device)
                )
                loss = (l1loss + l1alphaloss) * 0.5 * (
                    1.0 - cfg.ssim_lambda
