...
def rasterize_to_pixels(
    ...
    render_colors, render_alphas, contributions = _RasterizeToPixels.apply(
        means2d.contiguous(),
        conics.contiguous(),
        colors.contiguous(),
    ...
    return render_colors, render_alphas, contributions
...
class _RasterizeToPixels(torch.autograd.Function):
    ...
    def forward(
        ...
        render_colors, render_alphas, last_ids, contributions = _make_lazy_cuda_func(
