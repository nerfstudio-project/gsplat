...
void sh_fwd_launcher(
    ...
    sh_fwd_kernel<<<n_blocks_linear(n_elements), N_THREADS, shmem_size, stream>>>(
        N,
        K,
        degrees_to_use,
        dirs,
...
void sh_bwd_launcher(
    ...
    sh_bwd_kernel<<<n_blocks_linear(n_elements), N_THREADS, shmem_size, stream>>>(
        N,
        K,
        degrees_to_use,
        dirs,
