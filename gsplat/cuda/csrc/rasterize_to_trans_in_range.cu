...
/****************************************************************************
 * Rasterization to trans in Range
 ****************************************************************************/

template <typename T>
__global__ void rasterize_to_trans_in_range_kernel(
...
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor> rasterize_to_trans_in_range_tensor(
    ...
    if (cudaFuncSetAttribute(
            rasterize_to_trans_in_range_kernel<float>,
