...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("rasterize_to_pixels_from_world_nht_3dgs_fwd", &gsplat::rasterize_to_pixels_from_world_nht_3dgs_fwd);
    m.def("rasterize_to_pixels_from_world_nht_3dgs_bwd", &gsplat::rasterize_to_pixels_from_world_nht_3dgs_bwd);
#endif
    ...
    m.attr("encoding_expansion_factor") = ENCF;
    m.attr("num_encoding_frequencies") = ENCF;
    m.attr("feature_divisor") = VERTEX_PER_PRIM;
