// Description: This file contains the atomic operations for different data types.
// https://github.com/rusty1s/pytorch_scatter/blob/master/csrc/cuda/atomics.cuh
// MIT License
