...
#include "types.cuh"
#include "quat.cuh" // quat_to_rotmat, quat_to_rotmat_vjp

namespace gsplat {

template <typename T>
__device__ void quat_scale_to_covar_preci(
    const vec4<T> quat,
    const vec3<T> scale,
    // optional outputs
    mat3<T> *covar,
...
template <typename T>
__device__ void quat_scale_to_covar_vjp(
    // fwd inputs
    const vec4<T> quat,
    const vec3<T> scale,
    // precompute
...
template <typename T>
__device__ void quat_scale_to_preci_vjp(
    // fwd inputs
    const vec4<T> quat,
    const vec3<T> scale,
    // precompute
