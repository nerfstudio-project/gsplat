...
//
// hipcc-only: this header pulls in no torch/ATen headers. Backproject reuses the
// floored normalize3 / normalize3_bwd from math.hip.h; the floor never engages on
