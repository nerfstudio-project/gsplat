...
// kernel in camera_kernel.hip / camera_kernel_backward.hip, and forward-declares
...
void generate_image_points_launch(int64_t width, int64_t height, float *image_points, hipStream_t stream);
...
// Per-op scratch strides are listed at the top of ftheta_kernel.hip.h; all are
