...
template <typename T>
__device__ __forceinline__ constexpr T pi_const();
template <>
__device__ __forceinline__ constexpr float pi_const<float>() {
    return 3.14159265358979323846f;
}
template <>
__device__ __forceinline__ constexpr double pi_const<double>() {
...
// float64 -> 1e-40.
template <typename T>
__device__ __forceinline__ constexpr T normalize_normsq_floor();
template <>
__device__ __forceinline__ constexpr float normalize_normsq_floor<float>() {
    return 1.0e-20f;
}
template <>
__device__ __forceinline__ constexpr double normalize_normsq_floor<double>() {
    return 1.0e-40;
}
