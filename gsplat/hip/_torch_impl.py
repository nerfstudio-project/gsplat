...
def _fully_fused_projection(
    ...
    """PyTorch implementation of `gsplat.hip._wrapper.fully_fused_projection()`
...
def _isect_tiles(
    ...
    """Pytorch implementation of `gsplat.hip._wrapper.isect_tiles()`.
...
def _isect_offset_encode(
    ...
    """Pytorch implementation of `gsplat.hip._wrapper.isect_offset_encode()`.
...
def _isect_tiles_sparse(
    ...
    """Pytorch reference for ``gsplat.hip._wrapper.isect_tiles_sparse()``.
...
def _build_sparse_tile_layout(
    ...
    """Pytorch reference for ``gsplat.hip._wrapper.build_sparse_tile_layout()``.
...
def _rasterize_to_pixels(
    ...
    """Pytorch implementation of `gsplat.hip._wrapper.rasterize_to_pixels()`.
...
def _rasterize_to_pixels_sparse(
    ...
    """Pytorch reference for `gsplat.hip._wrapper.rasterize_to_pixels_sparse()`.
...
def _spherical_harmonics(
    ...
    """Pytorch implementation of `gsplat.hip._wrapper.spherical_harmonics()`."""
