...
# Note: merge this class into RowOffsetStructuredSpinningLidarModelParametersExt
@dataclass
class LidarTiling:
    n_bins_azimuth: int
    ...
    def __post_init__(self):
        ...
        # Note: These asserts are important, but we don't have the needed variables at this point.
...
def compute_angles_to_columns_map(
    ...
    # Note: if the fov_horiz_rad.span == 2*pi, the first and last columns (0 and 2*pi)
    ...
    # Note: this is quite slow and should be moved to CUDA.
...
def compute_histogram_equalization(
    ...
    *,
    ...
    # Note: use parameters.fov_eps_rad
