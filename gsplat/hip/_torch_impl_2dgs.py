...
from gsplat.hip._math import _quat_scale_to_matrix
from gsplat.hip._constants import MAX_ALPHA
...
def _fully_fused_projection_2dgs(
    ...
    """PyTorch implementation of `gsplat.hip._wrapper.fully_fused_projection_2dgs()`
...
def _rasterize_to_pixels_2dgs(
    ...
    """Pytorch implementation of `gsplat.hip._wrapper.rasterize_to_pixels_2dgs()`.
