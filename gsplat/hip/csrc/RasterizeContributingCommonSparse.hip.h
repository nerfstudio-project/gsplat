...
#include "Common.h"
#include "RasterizeSparseAddressing.hip.h"
#include "RasterizeToPixels3DGSDevice.hip.h"

namespace gsplat
{
// Sparse counterpart of rasterize_contributing_common_kernel
// (RasterizeContributingCommon.hip.h). It reuses the same per-op Accumulator
...
__global__ void rasterize_contributing_common_sparse_kernel(
