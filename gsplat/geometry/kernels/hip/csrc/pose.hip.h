...
// Device-side pose / SE3 / trajectory math. Paired with pose.hip (kernels,
// launches, exports). Includes quaternion.hip.h for shared quaternion device
...
// Shared quaternion primitives: quaternion.hip.h (QuatNormEps, quat_normalize_safe_*_write, quat_to_matrix_fwd_write).
