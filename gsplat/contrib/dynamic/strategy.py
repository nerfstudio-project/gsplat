...
class DynamicStrategy(DefaultStrategy):
    ...
    def initialize_state(self, *args, **kwargs) -> Dict[str, Any]:
        raise NotImplementedError("vnath_gsharp: DynamicStrategy.initialize_state pending")

    def step_pre_backward(self, *args, **kwargs) -> None:
        raise NotImplementedError("vnath_gsharp: DynamicStrategy.step_pre_backward pending")

    def step_post_backward(self, *args, **kwargs) -> None:
        raise NotImplementedError("vnath_gsharp: DynamicStrategy.step_post_backward pending")
